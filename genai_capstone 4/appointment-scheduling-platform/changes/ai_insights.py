...
def _strict_identity_check(text_content: str) -> dict:
    ...
    if valid_results:
        ...
        return {
            "valid": False,
            "message": f"⚠️ Document appears to be {best_attempt['type']}, but missing required information. Please ensure your document clearly shows: {', '.join(best_attempt['conditions_met'])}. Please re-upload.",
            "missing_fields": ["valid_identity"],
